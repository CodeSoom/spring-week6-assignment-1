...
class ProductControllerTest {
    ...
    void setUp() {
        ...
        given(authenticationService.isValidToken(VALID_TOKEN))
                .willReturn(true);

        given(authenticationService.isValidToken(INVALID_TOKEN))
    ...
    void updateWithInvalidToken() throws Exception {
        mockMvc.perform(
                ...
                .andExpect(status().isBadRequest())
                .andExpect(content().string(containsString("Please try again after logging in.")));
    }
